...
# MAGIC ## Streaming Data of Azure IOT Hub Data Engineering
...
# MAGIC * Azure IoT Hub 
# MAGIC * [Azure IoT Simulator](https://azure-samples.github.io/raspberry-pi-web-simulator/) executing for streaming data 
